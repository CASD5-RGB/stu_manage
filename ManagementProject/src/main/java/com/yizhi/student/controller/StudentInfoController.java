...
public class StudentInfoController {
	...
	public PageUtils list(@RequestParam Map<String, Object> params) {
		...
		List<StudentInfoDO> StudentInfoDO = studentInfoService.list(query);
		int total = studentInfoService.count(query);
		PageUtils pageUtils = new PageUtils(StudentInfoDO, total, query.getCurrPage(), query.getPageSize());
		return pageUtils;
	}
